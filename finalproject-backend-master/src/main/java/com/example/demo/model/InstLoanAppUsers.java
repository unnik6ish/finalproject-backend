...
public class InstLoanAppUsers {
	...
	public InstLoanAppUsers(String id, String name, String address, Long accno, Long mobno, String password) {
		super();
		this.id = id;
		this.name = name;
		this.address = address;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InstLoanAppUsers other = (InstLoanAppUsers) obj;
